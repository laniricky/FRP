...
const intentData = [
    {
        ...
        items: [
            ...
            { title: "Play Services App Info", desc: "Direct to Settings App Info", uri: "intent:com.google.android.gms#Intent;action=android.settings.APPLICATION_DETAILS_SETTINGS;scheme=package;end", icon: "ri-information-line" },
